                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <div class="card mb-4">
                                ...
                                <select id="customer_type" name="customer_type" class="form-control">
                                    ...
                                    <option value="{{ $customerKey }}"> {{ __($customerTypeName) }} </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-8" id="natural_person">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <x-text-input id="cpf" name="cpf" type="text" class="form-control" :value="old('cpf')" />
                                    <x-input-error class="mt-2" :messages="$errors->get('cpf')" />
                                </div>
                                <div class="col-md-6">
                                    <x-input-label for="birth_date" :value="__('Birth date')" />
                                    <x-text-input id="birth_date" name="birth_date" type="text" class="form-control" :value="old('birth_date')"/>
                        ...
                        <div class="col-md-4" id="juridical_person">
                            <div class="col-md-6">
                                ...
                                <x-text-input id="cnpj" name="cnpj" type="text" class="form-control" :value="old('cnpj')" />
